function Works() {
  return (
    <div class="h-screen snap-center max-w-7xl mx-auto w-full grid grid-cols-9 px-2">
      <div class="col-span-4 w-full h-3/6 mt-24">
      ...
      <div class="relative col-span-1 w-full h-full flex justify-center items-center">
        <div class="mt-24 h-full w-1 bg-indigo-300"></div>
      ...
      <div class="col-span-4 w-full h-3/6 mt-20">
        <div class="w-full h-full bg-indigo-400 rounded-md p-2 md:pl-4">
          <h1 class="text-white text-xl font-medium py-2">Title</h1>
          <p class="text-gray-100 sm:text-sm text-xs">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt
      ...
      <div class="relative col-span-1 w-full h-full flex justify-center items-center">
        <div class="mb-24 h-full w-1 bg-indigo-300"></div>
        <div class="absolute w-6 h-6 rounded-full bg-indigo-400 z-10 text-white text-center">
          3
        </div>
      </div>

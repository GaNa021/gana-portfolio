  ...
  return (
    <div className="group relative flex">
      <motion.img
        ...
        className="rounded-full border border-white-100 object-cover w-24 h-24 md:w-28 md:h-28 xl:w-32 xl:h-32 filter group-hover:grayscale transistion duration-300 ease-in-out shadow-lg shadow-slate-500"
        src={icon}
      />
